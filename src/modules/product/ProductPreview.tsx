...
import { Package, Download, X, Trash2, Loader2 } from 'lucide-react';
...
export function ProductPreview({ images, status, onClear }: ProductPreviewProps) {
  ...
  return (
    <div className="product-preview">
      <div className="product-preview-header">
        <div>
          <p className="eyebrow mini">Product Output</p>
